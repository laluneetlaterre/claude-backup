---
name: project_ben_ancestors_website
description: Ben(坂本家)の家族史サイト構築。home/Ben/。弥三郎=Ben祖父(経済学者)、俊=Ben父。格調・学術デザイン
metadata: 
  node_type: memory
  type: project
  originSessionId: 07914cdd-e94f-47a9-a330-09ab0921928b
---

夫 Ben（坂本家）の家族史サイトを構築中。Miey の網野家サイト（`home/ancestors/`）の**姉妹サイト**（別デザイン）。

- **場所**：`/Users/sakamotomitsue/Documents/home/Ben/`（Obsidian Vault 外・個人プロジェクト）。
- **中心人物**：坂本弥三郎（1904–1981）＝**Ben の祖父**。経済学者、神戸大学経済学部 初代学部長・初代 経済学研究科長、日本学術会議会員、経済学博士、勲二等瑞宝章。
- **続柄**：弥三郎（祖父）→ **坂本俊**（長男・**Ben の父**）→ Ben。※人事興信録の細字は「俊三」とも読めたが Miey 確認で名は「俊」。
