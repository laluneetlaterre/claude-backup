---
name: project-dormant-asset-revival-angle
description: 「休眠資産の再起動」はブランドど真ん中のコンテンツ角度。初心者向けより強い
metadata: 
  node_type: memory
  type: project
  originSessionId: bd5f5788-a53c-4c2b-ae65-4af6b7501ff4
  modified: 2026-07-31T13:12:44.479Z
---

**コンテンツの当たり角度＝「休眠資産の再起動」**（2026-07-31 Miey採用）。第1号ネタは eBay：
...
**How to apply:** YouTube・note・X のネタを考えるとき、「初めてやってみた」より **「昔やって放置していたものを、AIと一緒に生き返らせた」** を優先して探す。Miey の過去の休眠資産（旧アカウント・書きかけ原稿・使っていない契約・昔の資格やスキル）は全部ネタ候補。撮影は新規作業を増やさず、実作業の画面録画で済ませる（[[user_overwork_blindspot]] のとおり作業を二重に増やさない）。
